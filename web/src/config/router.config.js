...
//         component: RouteView,
//         meta: { title: '表单页', icon: 'form', permission: [] },
//         children: [
//           {
//             path: '/form/base-form',
//             name: 'BaseForm',
//             component: () => import('@/views/form/basicForm'),
//             meta: { title: '基础表单', keepAlive: true, permission: [] },
//           },
//           {
//             path: '/form/step-form',
//             name: 'StepForm',
...
//         meta: { title: '列表页', icon: 'table', permission: [] },
//         children: [
//           {
...
//             meta: { title: '查询表格', keepAlive: true, permission: [] },
//           },
//           {
